...
void errorLexico(int nroError,int li, int co){
  switch(nroError){
	case 1: printf("Error (1) léxico en la linea %d columna %d: Se inicia sección de comentario y no se finaliza. Se omite el carácter '}'\n",li,co);	
	        break;
	...
	case 3: printf("Error (3) léxico en la linea %d columna %d: El identificador excede el tamaño máximo permitido de 20 caracteres\n",li,co);	
	        break;
	case 4: printf("Error (4) léxico en la linea %d columna %d: El caractér no forma parte del alfabeto del lenguaje\n",li,co);	
	        break;
	case 5: printf("Error (5) léxico en la linea %d columna %d: Identificador/número mal formado\n",li,co);	
	        break;
	case 6: printf("Error (6) léxico en la linea %d columna %d: Caractér '}' inesperado.\n",li,co);	
	        break;        
	default: ;                                               	
  }
exit(1);  
